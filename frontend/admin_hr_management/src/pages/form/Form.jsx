...
const Form = () => {
    ...
    return (
        ...
        >
            ...
            <TextField
                error={Boolean(errors.ContactNamber)}
                helperText={Boolean(errors.ContactNamber) ? "Please provide a valid Phone number" : null}
                {...register("ContactNamber", { required: true, pattern: phoneRegExp })}
