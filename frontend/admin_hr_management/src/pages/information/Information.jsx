...
const Information = () => {
    ...
    const fetchInformation = async () => {
        ...
        try {
            ...
            const dataWithId = personalData.map(item => ({
                ...item,
                id: item.personal_info_id,
                department_name: departmentIdToNameMap[item.department_id] || "Unknown Department"
            }));
    ...
    const columns = [
        { field: "user_id", headerName: "ID", width: 70, align: "center", headerAlign: "center", editable: true },
        { field: "fullname", headerName: "Full Name", cellClassName: "name-column--cell", width: 170, editable: true },
        ...
        {
            field: "department_name", headerName: "Department Name", width: 210, editable: false,
            renderCell: (params) => {
                return (
    ...
    return (
        <Box sx={{ height: 600, width: '98%', mx: "auto" }}>
            <Header title={'Personal Information'} subTitle={'Manage all employees personal information'} />
            <DataGrid
                rows={rows}
                // @ts-ignore
                columns={columns}
